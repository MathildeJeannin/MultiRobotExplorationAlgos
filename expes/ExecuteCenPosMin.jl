...
if splited_path_to_map[4] == "first_maps"
    folder = "./expes/Logs/CenPosMin/type_of_map=$(splited_path_to_map[4]),num_map=$(split(splited_path_to_map[5], ".")[1][4:end])/"
else
    folder = "./expes/Logs/CenPosMin/type_of_map=$(splited_path_to_map[4])/"
